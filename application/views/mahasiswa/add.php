                        ...
                        <form id="mhs-form" data-parsley-validate class="form-horizontal form-label-left" action="<?= site_url('mahasiswas/proses'); ?>" method="POST">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <p>
                                        Pria:
                                        <input type="radio" class="flat" name="jenis_kelamin" value="L" checked="" required /> &nbsp; &nbsp; Wanita:
                                        <input type="radio" class="flat" name="jenis_kelamin" value="P" />
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <?= form_dropdown('prodi', $prodi, '', 'class="form-control" required'); ?>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <?= form_dropdown('tahun', $tahun, '', 'class="form-control" required'); ?>
                                </div>
                            </div>
