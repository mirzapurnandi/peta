...
function tampilSuperSubkategori(){
	subkategoriid = $("#subkategori").val();
	/*if(subkategoriid == ""){
		$("#supersubkategori").html("== Pilih Super Sub Kategori ==");
	}*/
	$.ajax({
		url: base_url + "ajax_function/get_supersubkategori",
		type: "POST",
		data: { subkategoriid : subkategoriid },
		dataType: "html",
		cache: false,
		success: function(response){
			$("#supersubkategori").html(response);
		}
	});
}